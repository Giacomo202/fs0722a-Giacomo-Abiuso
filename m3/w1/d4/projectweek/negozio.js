...
var fetchCapiAbbigliamento = function () { 
    return __awaiter(_this, void 0, void 0, function () {
    var response, json, capiAbbigliamento, _i, json_1, capoAbbigliamentoJson, capoAbbigliamento, error_1;
        ...
        switch (_a.label) {
            ...
            case 2:
                ...
                for (_i = 0, json_1 = json; _i < json_1.length; _i++) {
                    capoAbbigliamentoJson = json_1[_i];
                    capoAbbigliamento = new Abbigliamento(capoAbbigliamentoJson.id, capoAbbigliamentoJson.codprod, capoAbbigliamentoJson.collezione, capoAbbigliamentoJson.capo, capoAbbigliamentoJson.modello, capoAbbigliamentoJson.quantita, capoAbbigliamentoJson.colore, capoAbbigliamentoJson.prezzoivaesclusa, capoAbbigliamentoJson.prezzoivainclusa, capoAbbigliamentoJson.disponibile, capoAbbigliamentoJson.saldo);
...
async console.log(capiAbbigliamento);
